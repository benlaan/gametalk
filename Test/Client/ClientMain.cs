...
namespace Laan.Risk.GUI.Client
{
	...
	public class frmClient : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.gbPlayerDetails.Text = "Game Details";
			// 
			// btnConnectToGame
			// 
			...
			this.btnConnectToGame.Location = new System.Drawing.Point(336, 21);
			...
			this.lvAvailableGames.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
						...
						| System.Windows.Forms.AnchorStyles.Right)));
			this.lvAvailableGames.BackColor = System.Drawing.Color.LightGray;
			...
			this.tvObjectTree.ForeColor = System.Drawing.SystemColors.ActiveCaptionText;
		...
		{
			_availableGame.Add(new Game(name, host, port));
			UpdateGameList();
		}
