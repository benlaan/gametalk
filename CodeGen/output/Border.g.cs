...
namespace Laan.Risk.Border
{
    class Fields
    {
        ...
        internal const int Economy        = 4;
        internal const int Oil            = 5;
        internal const int Arms           = 6;
        internal const int ConnectionType = 7;
    }
    ...
    namespace Server
    {
        ...
        public partial class Border : BaseEntityServer
        {
            ...
            protected override List<EntityProperty> GetEntityProperties()
            {
                ...
                {
                    new EntityProperty() { Entity = _fromRegion, Field = Fields.FromRegion },
                    new EntityProperty() { Entity = _toRegion,   Field = Fields.ToRegion },
                };
            }
    ...
    namespace Client
    {
        ...
        public class BorderList : ClientEntityList<Border> { }
            ...
            protected override void DoModify(byte field, BinaryStreamReader reader)
            {
                ...
                switch (field)
                {
                    case Fields.FromRegion:
                        _fromRegion = (Regions.Region)(ClientDataStore.Instance.Find(reader.ReadInt32()));
                        break;
                    case Fields.ToRegion:
                        _toRegion = (Regions.Region)(ClientDataStore.Instance.Find(reader.ReadInt32()));
                        break;
                    case Fields.Economy:
                        _economy = reader.ReadInt32();
                        break;
