...
namespace Laan.GameLibrary
{
    public class Config
    {
        ...
        {
            get {
                return ReadInt("OutboundPort", 50000);
            }
        }
        ...
        {
            get {
                return ReadInt("InboundPort", 50001);
            }
        }
        ...
        {
            get {
                return ReadInt("RendezvousPort", 50002);
            }
        }
        ...
        {
            get {
                return ReadInt("RendezvousFrequency", 3000);
            }
        }
