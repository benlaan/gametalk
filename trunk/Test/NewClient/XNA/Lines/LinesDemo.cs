...
namespace LinesDemo
{
    ...
    public class LinesDemo : Microsoft.Xna.Framework.Game
    {
        ...
        List<LineSegment> gridLineList = new List<LineSegment>();
        List<LineSegment> triangleLineList = new List<LineSegment>();
        List<LineSegment> octLineList = new List<LineSegment>();
        List<LineSegment> starLineList = new List<LineSegment>();
        List<LineSegment> miscLineList = new List<LineSegment>();
        ...
        public LinesDemo()
        {
            ...
            for (int i = -10; i <= 10; i++)
            {
                ...
                gridLineList.Add(new LineSegment(new Vector2(i, -10), new Vector2(i, 10), 0.05f, Color.DarkBlue));
                gridLineList.Add(new LineSegment(new Vector2(-10, i), new Vector2(10, i), 0.05f, Color.DarkBlue));
            }
            // Add major axes to gridLineList last so they draw on top of other lines
            gridLineList.Add(new LineSegment(new Vector2(0, -20), new Vector2(0, 20), 0.05f, Color.Cyan));
            gridLineList.Add(new LineSegment(new Vector2(-20, 0), new Vector2(20, 0), 0.05f, Color.Cyan));

            // Create a triangle from three lines
            triangleLineList.Add(new LineSegment(new Vector2(2, 2), new Vector2(8, 2)));
            triangleLineList.Add(new LineSegment(new Vector2(8, 2), new Vector2(5, 8)));
            triangleLineList.Add(new LineSegment(new Vector2(5, 8), new Vector2(2, 2)));
            ...
            miscLineList.Add(new LineSegment(new Vector2(2, -2), new Vector2(8, -2), 0.10f, Color.Salmon));
            miscLineList.Add(new LineSegment(new Vector2(4, -4), new Vector2(6, -4), 0.20f, Color.Gainsboro));
            miscLineList.Add(new LineSegment(new Vector2(5, -6), new Vector2(5, -6), 0.50f, Color.Firebrick));
            Color myColor = new Color(108, 35, 108, 200); // note transparency
            miscLineList.Add(new LineSegment(new Vector2(2, -7), new Vector2(8, -9), 0.30f, myColor));
            miscLineList.Add(new LineSegment(new Vector2(2, -9), new Vector2(8, -7), 0.30f, myColor));
        }
        ...
        /// </summary>
        void AddPolyLine(List<LineSegment> lineList, params Vector2[] vectors)
        {
            Vector2 p1;
            ...
            for (int iVec = 1; iVec < vectors.Length; iVec++)
            {
                p1 = p2;
                p2 = vectors[iVec];
                lineList.Add(new LineSegment(p1, p2));
            }
        }
